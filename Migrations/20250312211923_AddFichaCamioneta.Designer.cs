...
namespace Inventario360.Migrations
{
    ...
    [Migration("20250312211923_AddFichaCamioneta")]
    partial class AddFichaCamioneta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventario360.Models.Camioneta", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("FechaAntivuelcos")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FechaGPS")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FechaLaminas")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Inventario360.Models.FichaCamioneta", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventario360.Models.Camioneta", b =>
                {
                    b.HasOne("Inventario360.Models.Empleado", "Responsable")
                        .WithMany()
